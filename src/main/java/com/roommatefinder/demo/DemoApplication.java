	...
	public static void main(String[] args) {
	  ...
	  public CommandLineRunner demo(PersonRepository repository) {
	    return (args) -> {
	        ...
	        person1.setRoommatePreferences(new RoommatePreferences(true, true, true, "India", 20, 30, "F", 85281, 1000, true, 2));
            ...
            person3.setRoommatePreferences(new RoommatePreferences(true, true, false, "India", 20, 30, "F", 85281, 1000, true, 2));
